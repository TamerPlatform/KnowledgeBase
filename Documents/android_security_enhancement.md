...
| 5.0 | Fixed : Privilege Escalation using ObjectInputStream | In Android <5.0, java.io.ObjectInputStream did not check whether the Object that is being deserialized is actually serializable. | [Fixed Commit][5]   [POC : CVE-2014-7911][6] |
| 5.0 | Fixed : SMS resend vulnerability | Applications can send SMS without privilege leading to undesired cost to user or be used for data exfiltration | [Fixed commit][7]  [POC for CVE-2014-8610 ][8] |
...
| 4.4.4 | Block access to java.lang.Object.getClass in injected Java objects | Throws a java.lang.SecurityException on Browser UI thread when an attempt is  made to execute java.lang.Object.getClass from JavaScript code via an injected  Java object. | Refer : [Chromium BugTrack entry][10]  [Chromium Issue entry][11] |
| 4.4.4 | Fix for OpenSSL man-in-the-middle | CVE ID : CVE-2014-0224 | Refer : [CVE 2014-0224 Entry][12] |
| 4.4.3 | Chrome Vulnerability Fix | 1\. timing-based security attack in Chrome2\. fix for CVE-2014-1710| [Chromium Bug Tracker Entry][13]Refer : [CVE 2014-1710][14] |
...
| 4.4 | WRITE_EXTERNAL_STORAGE permission to write to SDCARD | This permission is required by applications in order to write to External Storage i.e. SDCARD. | [Android External Storage write permission ][19] Also read [Storing app data on SD cards][20] | 
